...
/****** Object:  Database [Hospital_Database]    Script Date: 12.06.2022 14:11:26 ******/
CREATE DATABASE [Hospital_Database]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'projetIntegrateur', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\projetIntegrateur.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'projetIntegrateur_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\projetIntegrateur_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Hospital_Database] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [Hospital_Database] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
